...
const grid_list = [
  {x:0, y:0, px: 285, py: 333},     // col 0, row 0
  {x:0, y:1, px: 283, py: 377.5},   // col 0, row 1
  {x:0, y:2, px: 284, py: 424},     // col 0, row 2
  {x:0, y:3, px: 282, py: 467.5},   // col 0, row 3
  {x:0, y:4, px: 283, py: 512},     // col 0, row 4
  {x:0, y:5, px: 283, py: 556},     // col 0, row 5
  {x:1, y:0, px: 318, py: 330},     // col 1, row 0
  {x:1, y:1, px: 317, py: 374.5},   // col 1, row 1
  {x:1, y:2, px: 316, py: 419},     // col 1, row 2
  {x:1, y:3, px: 317, py: 463.5},   // col 1, row 3
  {x:1, y:4, px: 317, py: 508},     // col 1, row 4
  {x:1, y:5, px: 318, py: 550},     // col 1, row 5
  {x:2, y:0, px: 351, py: 327},     // col 2, row 0
  {x:2, y:1, px: 350.3, py: 371.5}, // col 2, row 1
  {x:2, y:2, px: 350, py: 416},     // col 2, row 2
  {x:2, y:3, px: 349, py: 460.5},   // col 2, row 3
  {x:2, y:4, px: 349, py: 502},     // col 2, row 4
  {x:2, y:5, px: 349.5, py: 545},   // col 2, row 5
  {x:3, y:0, px: 384, py: 324},     // col 3, row 0
  {x:3, y:1, px: 383.5, py: 368.5}, // col 3, row 1
  {x:3, y:2, px: 383, py: 413},     // col 3, row 2
  {x:3, y:3, px: 383.5, py: 454.5}, // col 3, row 3
  {x:3, y:4, px: 385, py: 498},     // col 3, row 4
  {x:3, y:5, px: 384.8, py: 539},   // col 3, row 5
  {x:4, y:0, px: 417, py: 321},     // col 4, row 0
  {x:4, y:1, px: 416.6, py: 365},   // col 4, row 1
  {x:4, y:2, px: 416.7, py: 406},   // col 4, row 2
  {x:4, y:3, px: 416.6, py: 451},   // col 4, row 3
  {x:4, y:4, px: 416.9, py: 493},   // col 4, row 4
  {x:4, y:5, px: 417.5, py: 535},   // col 4, row 5
  {x:5, y:0, px: 450, py: 318},     // col 5, row 0
  {x:5, y:1, px: 449.6, py: 362.5}, // col 5, row 1
  {x:5, y:2, px: 449.6, py: 405.5}, // col 5, row 2
  {x:5, y:3, px: 450, py: 447},     // col 5, row 3
  {x:5, y:4, px: 450.5, py: 489},   // col 5, row 4
  {x:5, y:5, px: 451, py: 527},     // col 5, row 5
  {x:6, y:0, px: 483, py: 315},     // col 6, row 0
  {x:6, y:1, px: 482, py: 358},     // col 6, row 1
  {x:6, y:2, px: 482, py: 399},     // col 6, row 2
  {x:6, y:3, px: 480.8, py: 442},   // col 6, row 3
  {x:6, y:4, px: 480.8, py: 484},   // col 6, row 4
  {x:6, y:5, px: 480, py: 523},     // col 6, row 5
];
...
function create_snake() {
  return {
    alive: true,
    vel: {x: 0, y: -1},     // falling down #realism #cuttingedgephysics
    tail: [ {x: 4, y: 0} ]  // the space just below the boys hand
  };
}
